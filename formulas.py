...
class Conjunction(BinaryFormula):
    ...
    def __eq__(self, other):
        ...
        return self.operator == other.operator and \
            self.fst_operand == other.fst_operand and self.snd_operand == other.snd_operand
...
class Forall(Quantifier):
    ...
    def substitute(self, x, term):
        ...
        if x == self.variable:
            ...
            return Forall(new_variable, 
                self.sub_formula.substitute(self.variable, new_variable).substitute(x, term))
